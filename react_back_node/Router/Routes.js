...
const imageValidation = require("../Functions/FileHandler/imagHandler");
...
router.post("/ajoutArticle", imageValidation.single('image'), validatioonArticleText.checkArticle, articleController.addArticle)
