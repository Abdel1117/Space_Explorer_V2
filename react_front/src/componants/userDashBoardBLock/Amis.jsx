...
export default function Amis() {
    return (
        <div className='flex flex-wrap lg:flex-nowrap w-full shadow-lg bg-white dark:bg-[#252525]'>

            <div className='w-full lg:w-4/12 xl:w-5/12 m-0 md:m-4 shadow-lg rounded-lg bg-[#F5F5F5] dark:bg-[#252525]'>
