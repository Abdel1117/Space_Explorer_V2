...
export default function Table({ articles, selectedRow, loading }) {
                            ...
                            return (
                                <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" >
                                    <td className="w-4 p-4">
                                        <div className="flex items-center">
                                            <input onChange={() => selectedRow(index, articles)} id="checkbox-table-search-1"
                                                type="checkbox"
                                                checked={index === articleSelected}
