...
export default function FormUser() {
  return (
    <div classNameName='block w-full dark:bg-[#252525] bg-white'>
     
        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
      <form>
        <h6 className="text-blueGray-400 text-sm mt-3 mb-6 font-bold uppercase px-1 px-4">
          User Information
        </h6>
        <div classNameName='w-full md:w-4/12 my-4 px-1 md:px-4 '>
            <div classNameName='border w-full lg:w-[300px] h-[150px] lg:h-[300px]'>

            </div>
            <div classNameName='mt-4'>
                <input classNameName='text-sm lg:text-md' type="file" name="" id="" />
                <label classNameName='' htmlFor="avatar_Image">Télècharger une image de profil</label>
            </div>
        </div>
