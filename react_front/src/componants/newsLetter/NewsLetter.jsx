...
export default function NewsLetter() {
  return (
    <div className='sm:col-span-4 lg:col-span-3 p-5 max-h-[200px] grid content-center bg-slate-400 mb-5'>
      <h2 className='text-md md:text-xl'>NewsLetter</h2>
      <form action="">
        <label htmlFor="mailNewsletter">Adresse Email</label>
        <input id='mailNewsletter' name='mailNewsletter' className='my-4 p-2 text-sm  w-full' type="mail" placeholder='Entrer votre email' />
