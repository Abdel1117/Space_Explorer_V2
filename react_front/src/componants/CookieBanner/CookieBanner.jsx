...
import { setCookie } from "../../Functions/CookiesFunction/CookiesFunction"
export const CookieBanner = () => {
    const [bannerVisible, setBanneVisible] = useState(true)
    const handleCookieChose = (value) => {
        setBanneVisible(false)
        ...
        !bannerVisible ? null :
            ...
            <div className='bg-white border rounded-md shadow-xl min-w-[fit-content] mx-auto p-3 md:p-5 animate-fadeIn fixed bottom-[50%] right-[50%] translate-x-[50%] translate-y-[50%] flex flex-col  items-center justify-center z-50 '>
                ...
                <div className='flex justify-between items-center w-full min-w-[280px] py-4 md:mt-5'>
                    <button onClick={(e) => { handleCookieChose(e.target.value) }} value={true} className='min-w-[100px] outline-none p-1 rounded-md text-white bg-blue-500 hover:bg-blue-600'>
                        Accepter
                    </button>
                    <button onClick={(e) => { handleCookieChose(e.target.value) }} value={false} className='min-w-[100px] outline-none p-1 rounded-md text-white bg-red-600 hover:bg-red-700'>
                        Refuser
                    </button>
                </div>
