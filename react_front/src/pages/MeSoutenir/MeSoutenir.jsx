        ...
        <section className="min-h-screen">
            ...
            <div className='border dark:border-white border-black mx-auto w-9/12 md:w-[800px] min-h-[400px] '>
                ...
                <div className='grid grid-cols-3'>
                    <div className='h-[200px] w-auto border border-black dark:border-white'>
                    ...
                    <div className='h-[200px] w-auto border border-black dark:border-white'>
                        <h2 className="text-black dark:text-white text-xl md:t className='mx-auto'ext-3xl text-center mt-10 font-bold">15€</h2>
