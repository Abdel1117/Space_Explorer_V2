...
export const NousContacter = () => {
    ...
    return (
        <section className='min-h-[100vh] '>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Space Explorer | Nous Contacter </title>
                <meta name="description" content="Space Explorer page de Contact." />
            </Helmet>
            <div className="py-6 px-4 md:px-0">
                <div className="max-w-6xl mx-auto bg-light-blue dark:bg-dark-blue rounded-lg">
                    <div className="grid md:grid-cols-2 items-center  gap-16 sm:p-10 p-4 font-[sans-serif]">
                        <div className=''>
                            <h1 className="text-4xl font-extrabold text-white">Nous contacter</h1>
                            <p className="text-sm text-gray-400 mt-3">Si vous avez besoin de nous contacter, n'hésitez pas !</p>
                            <ul className="mt-12 space-y-8">
                                <li className="flex items-center">
                                    ...
                                    <a href="mailto:abderahmane.adjali@live.fr" className="text-white text-sm ml-3">
                                ...
                                <li className="flex items-center">
                                    ...
                                    <div className="text-white text-sm ml-3">
                                        <strong>8 rue des lilas </strong>
                                        <br />
                                        <strong>93600 Aulnay-sous-Bois </strong>

                                    </div>
                                </li>
                            </ul>
                            <ul className="flex mt-12 space-x-4">
                                <li className="bg-violet-600 hover:bg-green-400 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                    <a href="#">
                                ...
                                <li className="bg-violet-600 hover:bg-green-400 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                    <a target='_blank' href="https://www.instagram.com/spaceexplorer2223/">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
                                            viewBox="0 0 24 24">
                                            <path
